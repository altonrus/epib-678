...
![](figs/jensen_inequality.jpg) Source: [K Shanti Priya on Medium](https://medium.com/@k.shantipriya27/jensens-inequality-unveiling-its-power-in-data-science-and-machine-learning-ecf75cadf10f)

## Implications for modelling choice

For a non-linear model $f()$, individual parameters $X$, and model output $Y$:
