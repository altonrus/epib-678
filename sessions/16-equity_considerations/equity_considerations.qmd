...
-   [**Value of information analysis (continued, PDF on Mycourses)**]{.underline}
...
-   [**Equity in health technology assessment policies**]{.underline}
...
-   Portfolio of services may be viewed as unfair if it:
    ...
    -   Excacerbates existing inequities in health outcomes
...
-   **Resource:** prioritize interventions that require fewer resources
...
-   Do they consider age?
    ...
    -   Not explicitly, but average patient age for disease is "baked in"

## Public support for severity-adjusted thresholds mixed

And sensitive to how the question is phrased

![](figs/Reckers-Droog%20support%20proportional%20shortfall.png)
...
-   [**Low consensus**]{.underline} on specific, quantitative decision criteria for trading off equity vs. efficiency (QALY maximization)
...
-   [**Methods for decision-analytic modelers**]{.underline}
...
Andrew Mirelman (2015) [Methods for incorporating health equity impacts in economic evaluation with applications to low and middle income countries](https://www.york.ac.uk/che/seminars/economic-evaluation/2015/andrew-mirelman/)
...
**Con:** no explicit quantification of inequity (addresses half of the equity-efficiency trade-off)
...
**Con:** complex calculation; defining "optimal" equity-equity trade-off is very challenging
...
## Next class: First applied guest lecture

-   Complete reading

-   Look at code when available

-   Come with at least one question
...
-   *Winter reading week March 2 to March 6*
