...
subtitle: "EPIB  678 session 12, McGill University"
...
## Continuing material on PSA

<https://htmlpreview.github.io/?https://github.com/altonrus/epib-678/blob/main/sessions/11-uncertainty_analysis/uncertainty_analysis.html#/cost-effectiveness-acceptability-curve-1>
...
-   Integrate (data-informed) parameters
...
-   Data collection plan for costs and QALY estimation
    ...
    -   Periodic surveys to derive health-related quality of life weights & non-health outcomes (productivity, caregiver, time costs)

## Trial-based economic evaluation

Statistical methods often sufficient for conducting CEA over time horizon of the trial
...
Extrapolating over patient lifetime may use mathematical modeling
...
-   Often, some individuals right censored (end of follow-up)
...
-   Ex. chlamydia infection between screen $n$ and $n-1$
...
-   Hazard ratios estimated for covariates

    -   HR \>1 if covariate associated with shorter time-to-event
...
-   "Time spent progression-free" impacts progression → death transition
